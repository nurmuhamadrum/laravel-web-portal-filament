    ...
    <body class="font-[Poppins] pb-[72px]">
        ...
        <section id="Featured" class="mt-[30px]">
            <div class="main-carousel w-full">
                ...
                @empty
                    <p class="text-lg font-semibold text-gray-500">No featured articles available</p>
                @endforelse
            </div>
        </section>

        {{-- Not Featured Section --}}
        <section id="Up-to-date" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
            ...
            <div class="grid grid-cols-3 gap-[30px]">
                ...
                @empty
                    <p class="text-lg font-semibold text-gray-500">No articles available</p>
                @endforelse
            </div>
        </section>
        ...
        <section id="Best-authors" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
            ...
            <div class="grid grid-cols-6 gap-[30px]">
                ...
                @empty
                    <p class="text-lg font-semibold text-gray-500">No authors available</p>
                @endforelse
            </div>
        </section>
        ...
        <section id="Advertisement" class="max-w-[1130px] mx-auto flex justify-center mt-[70px]">
            ...
            <div class="flex flex-col gap-3 shrink-0 w-fit">
                <a href="{{ $banner_ads->link }}" class="w-[900px] h-[120px] flex shrink-0 rounded-2xl overflow-hidden">
        ...
        <section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
            ...
            <div class="flex justify-between items-center h-fit">
                ...
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <img src="{{ Storage::url($featured_entertainment_articles->thumbnail) }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="icon" />
                    <div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10">
                    </div>
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="details.html"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ $featured_entertainment_articles->name }}</a>
                            <p class="text-white">{{ $featured_entertainment_articles->created_at->format('M d, Y') }}</p>
                        </div>
                    </div>
                </div>
                <div class="h-[424px] w-fit px-5 overflow-y-scroll overflow-x-hidden relative custom-scrollbar">
                    <div class="w-[455px] flex flex-col gap-5 shrink-0">
                        ...
                        @empty
                            <p class="text-lg font-semibold text-gray-500">No entertainment articles available</p>
                        @endforelse
                    </div>
                    <div
